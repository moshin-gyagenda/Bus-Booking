                        ...
                        <div class="row">
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-lg-8 col-md-12">
                                                <h3 class="card-title">Bus Routes Analysis</h3>
                                            ...
                                            <div class="col-lg-4 col-md-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-9">Bundibugyo</div>
                            ...
                            <div class="col-md-4">
                                <div class="card" style="min-height: 422px;">
                                    <div class="card-header"><h3>Performance Monitoring</h3></div>
                                    <div class="card-body">
