                ...
                <div class="main-content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header"><h3> Ticket Payment</h3></div>
                                    <div class="card-body">
                                        <table id="data_table" class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{$ticket->id}}</td>
                                                    <td>{{$ticket->first_name.' '.$ticket->other_name}}</td>
                                                    <td>{{$ticket->phone_number}}</td>
                                                    <td> <span class="custom-badge btn btn-warning" style="text-align: center; color: white; height:25px;">Not Paid</span> </td>
                                                    <td>{{$ticket->from.'-'.$ticket->to}}</td>
                                                    <td>{{$ticket->amount}}</td>
                                                    <td> <span class="btn btn-success">Pay</span></td>
                                                    <td>
                                                        <div class="table-actions">
                                                            {{-- <a href="{{ route('tickets', $ticket->id) }}"><i class="fa fa-pay"></i></a> --}}
