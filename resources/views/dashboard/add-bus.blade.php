                ...
                <div class="main-content">
                    <div class="container-fluid">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{route('add-buses')}}" method="POST">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8 col-lg-10">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="name" style="border:1px solid green ">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <label class="col-sm-4 col-lg-2 col-form-label">Number Plate</label>
                                        <div class="col-sm-8 col-lg-10">
                                            <div class="input-group">
                                                <span class="input-group-prepend">
                                                    <label class="input-group-text" style="border:1px solid green "><i class="ik ik-volume"></i></label>
                                                </span>
                                                <input type="text" class="form-control" name="number_plate" style="border:1px solid green ">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8 col-lg-10">
                                            <div class="input-group">
                                                ...
                                                <textarea type="text" class="form-control" name="description" style="border:1px solid green "></textarea>
                                            </div>
                                        </div>
                                    </div>
