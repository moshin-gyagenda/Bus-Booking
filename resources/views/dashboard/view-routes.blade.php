                ...
                <div class="main-content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header"><h3>Route Management</h3></div>
                                    <div class="card-body">
                                        <table  class="table">
                                            <thead>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="table-actions">
                                                            <a href="" ><i class="ik ik-eye btn btn-link p-0"></i></a>
                                                            <a href=""><i class="ik ik-edit-2 btn btn-link p-0"></i></a>
                                                            {{-- <form action="{{ route('routes.destroy', $route->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this route?')">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="submit" class="btn btn-link p-0"><i class="ik ik-trash-2"></i></button>
                                                            </form> --}}
                                                        </div>
                                                    </td>
