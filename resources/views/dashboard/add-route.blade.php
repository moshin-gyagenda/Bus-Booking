                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8 col-lg-10">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="route_from" style="border:1px solid green ">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8 col-lg-10">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="route_to" style="border:1px solid green ">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <label class="col-sm-4 col-lg-2 col-form-label">Amount</label>
                                        <div class="col-sm-8 col-lg-10">
                                            <div class="input-group">
                                                
                                                <input type="text" class="form-control" name="amount" style="border:1px solid green ">
                                            </div>
                                        </div>
                                    </div>
