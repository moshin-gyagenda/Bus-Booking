    ...
    <body>
        ...
        <main class="col-md-12">
            <div class="col-md-8 col-lg-7 col-xl-6 mx-auto window">
                <div class="container">
                    <h4 style="color: green">Login to Your Account</h4>
                    <form action="{{route('user-login')}}" method="POST">
                        @csrf 
                      <div class="form-group">
                        <label for="email">Email <span style="color: red">*</span></label>
                        <input type="email" class="form-control btn-outline-success" name="email" placeholder="Enter email">
                      </div>
                      <div class="form-group">
                        <label for="password">Password <span style="color: red">*</span></label>
                        <input type="password" class="form-control btn-outline-success" name="password" placeholder="Enter password">
                      </div>
                      <button type="submit" class="btn btn-success" style="width: 200px">Login</button>
                      <button type="submit" class="btn btn-warning" style="width: 150px">Register</button>
                    </form>
                  </div>
